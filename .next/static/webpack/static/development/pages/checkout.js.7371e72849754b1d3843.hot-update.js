...
function CheckoutForm(_ref) {
  ...
  var handleCheckBox = function handleCheckBox(e) {
    if (e.target.checked) {
      console.log(js_cookie__WEBPACK_IMPORTED_MODULE_15___default.a.get("user"));
    }
  };
