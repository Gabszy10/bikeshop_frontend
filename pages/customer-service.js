            ...
            <section className="customer-service-area ptb-60">
              <div className="container">
                ...
                <div className="customer-service-content">
                  <h3>
                    <i className="fas fa-gift"></i> Shipping Times and Costs
                  </h3>
                  <ul>
                    <li>
                  ...
                  <h3>
                    <i className="far fa-credit-card"></i> Payment Methods
                  </h3>
                  ...
                  <h3>
                    <i className="fas fa-sync"></i> Exchanges, Returns and
                    Refunds
                  </h3>
                  <p>
                    Items returned within 14 days of their original shipment
                    date in same as new condition will be eligible for a full
                    refund or store credit. Refunds will be charged back to the
                    original form of payment used for purchase. Customer is
                    responsible for shipping charges when making returns and
                    shipping/handling fees of original purchase is
                    non-refundable.
                  </p>
                </div>
              </div>
