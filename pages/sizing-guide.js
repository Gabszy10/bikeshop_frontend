              ...
              <div className="container">
                ...
                <div className="sizing-guide-table">
                  ...
                  <ul className="sizing-guide-info">
                    <li>
                      <span>Chest:</span> Around the fullest part of the neck,
                      at the base.
                    </li>
                    <li>
                      <span>Waist:</span> Around the narrowest part of the
                      waist.
                    </li>
                    <li>
                      <span>Hips:</span> Around the widest point of the hips.
                    </li>
                    <li>
                      <span>Skort Lengths:</span> From the crotch to the
